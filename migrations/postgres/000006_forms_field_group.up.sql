-- Field group: one question that holds several labelled text sub-fields under a
-- single icon (e.g. a "Name" block: prefix/first/last…, or "Organisation":
-- company/role/department). Its answer is a JSON object keyed by sub-field.
-- The sub-field definitions live in questions.options.fields; nothing schema-side
-- changes except widening the allowed question_type set.
