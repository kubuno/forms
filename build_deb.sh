...
#   /usr/lib/kubuno/modules/forms/{kubuno-forms, module.toml, frontend/}
#   /usr/share/kubuno/modules/forms/migrations/*.sql
#   /etc/kubuno/modules/forms/config.toml.example
#
# Usage :
